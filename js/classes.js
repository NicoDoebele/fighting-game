...
//fighter -> player and enemy object
class Fighter extends Sprite{
    constructor({position, velocity, color = 'red', imageSrc, scale = 1, framesMax = 1, offset = {x: 0, y: 0}, sprites, attackBox = {offset: {}, width: undefined, height: undefined}}) {
        ...
        this.width = 50;
        this.lastKey;
        this.attackBox = {position: {x: this.position.x, y: this.position.y}, width: attackBox.width, height: attackBox.height, offset: attackBox.offset};
        this.color = color;
        this.isAttacking;
        this.health = 100;
        this.framesCurrent = 0;
    ...
    takeHit() {
        ...
        if (!this.invincible) this.health -= 20;
        ...
        setTimeout(()=>{ this.invincible = false; }, 80);
    }
